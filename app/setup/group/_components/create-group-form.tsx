    ...
    <>
      <div className="h-auto w-auto mt-[35px]">
          ...
          <div className="flex items-center justify-center flex-col px-4 bg-zinc-200 dark:bg-zinc-700 rounded-md shadow-md  py-3 gap-4">
              ...
              <p className="text-muted-foreground text-xs">You can edit your group at anytime after creation.</p>
              <Divider/>
        ...
        <Divider/>
         ...
         <div className="flex items-center flex-col justify-center gap-2 w-full">
          <div className="w-full">
          <Switch defaultSelected size="sm" onClick={()=>handleClick()}> <p className="text-xs">Change Group Avatar?</p></Switch>
          </div>
          <Divider/>
          <p className="text-muted-foreground text-xs">Default image will be your avatar image.</p>
          {upload && (
        <FormField
          control={form.control}
          name="imageUrl"
